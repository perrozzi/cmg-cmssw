...
outfolder_prefix = "feb28"

### Muon trigger efficiency
useEffSF = 6  # 0=no, 1=MuonPOG, 2=Heiner all, 3=Heiner no tight, 4=Heiner no iso, 5=Heiner no tight subleading mu, 6=Heiner no hlt
...
## NEW FIT
runClosureTestLikeLihoodRatio = 1  # 1: also executes merge if not using batch jobs
mergeResults = 0
